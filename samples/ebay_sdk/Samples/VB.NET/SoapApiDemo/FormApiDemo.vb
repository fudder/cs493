...
#End Region
    ...
    Private Sub FillCommandListBox()
        ...
        AddCommandToListBox("GetAttributesCS", GetType(FormGetAttributesCS))
        AddCommandToListBox("GetAttributesXSL", GetType(FormGetAttributesXSL))
        ...
        AddCommandToListBox("GetCategory2CS", GetType(FormGetCategory2CS))
        AddCommandToListBox("GetCategoryListings", GetType(FormGetCategoryListings))
        ...
        AddCommandToListBox("GetProductFinder", GetType(FormGetProductFinder))
        AddCommandToListBox("GetProductFinderXSL", GetType(FormGetProductFinderXSL))
        AddCommandToListBox("GetProductSearchPage", GetType(FormGetProductSearchPage))
        AddCommandToListBox("GetPromotionRules", GetType(FormGetPromotionRules))
        AddCommandToListBox("GetSearchResults", GetType(FormGetSearchResults))
