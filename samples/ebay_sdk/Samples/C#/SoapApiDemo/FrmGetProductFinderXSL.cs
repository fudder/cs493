...
namespace SoapLibraryDemo
{
	...
	/// </summary>
	public class FrmGetProductFinderXSL : System.Windows.Forms.Form
	{
		public ApiContext Context;
		private System.Windows.Forms.GroupBox GrpResult;
		private System.Windows.Forms.Label LblAttributeData;
		private System.Windows.Forms.TextBox TxtAttributeData;
		private System.Windows.Forms.Button BtnGetProductFinderXSL;
		/// <summary>
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;

		public FrmGetProductFinderXSL()
		{
			//
		...
		{
			this.BtnGetProductFinderXSL = new System.Windows.Forms.Button();
			...
			// 
			this.BtnGetProductFinderXSL.Location = new System.Drawing.Point(200, 8);
			this.BtnGetProductFinderXSL.Name = "BtnGetProductFinderXSL";
			this.BtnGetProductFinderXSL.Size = new System.Drawing.Size(128, 23);
			this.BtnGetProductFinderXSL.TabIndex = 9;
			this.BtnGetProductFinderXSL.Text = "GetProductFinderXSL";
			this.BtnGetProductFinderXSL.Click += new System.EventHandler(this.BtnGetProductFinderXSL_Click);
			// 
			// GrpResult
			// 
			...
			this.Controls.Add(this.BtnGetProductFinderXSL);
			this.Name = "FrmGetProductFinderXSL";
			this.Text = "GetProductFinderXSL";
		...
		private void BtnGetProductFinderXSL_Click(object sender, System.EventArgs e)
		{
			try
			{
				GetProductFinderXSLCall apicall = new GetProductFinderXSLCall(Context);
				apicall.DetailLevelList.Add(DetailLevelCodeType.ReturnAll);

				XSLFileTypeCollection attfiles = apicall.GetProductFinderXSL();
