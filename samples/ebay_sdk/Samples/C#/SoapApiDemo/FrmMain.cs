...
namespace SoapLibraryDemo
{
	...
	public class FrmMain : System.Windows.Forms.Form
	{
		...
		public FrmMain()
		{
			...
			AddCommandToListBox("GetAttributesCS", typeof(FrmGetAttributesCS));
			...
			AddCommandToListBox("GetSearchResults", typeof(FrmGetSearchResults));
			...
			AddCommandToListBox("GetCategory2CS", typeof(FrmGetCategory2CS));
			AddCommandToListBox("GetCategoryListings", typeof(FrmGetCategoryListings));
			AddCommandToListBox("ReviseItem", typeof(FrmReviseItem));
			AddCommandToListBox("GetAttributesXSL", typeof(FrmGetAttributesXSL));
			AddCommandToListBox("GetMemberMessages", typeof(FrmGetMemberMessages));


			AddCommandToListBox("GetProductFinderXSL", typeof(FrmGetProductFinderXSL));
			AddCommandToListBox("GetProductSearchPage", typeof(FrmGetProductSearchPage));
			...
			AddCommandToListBox("GetProductFinder", typeof(FrmGetProductFinder));
