...
namespace eBay.Service.Core.Sdk
{
	...
	/// <summary>
	/// Base class for all <see cref="eBay.Service.Call"/> classes.
	/// </summary>
	...
	public class ApiCall
	{
		...
		/// 
		/// </summary>
		/// <param name="ApiContext">The <see cref="ApiContext"/> for this API Call.</param>
		...
		/// <summary>
		/// Sends the <see cref="AbstractRequest"/> to eBay.
		/// </summary>
		...
		/// <summary>
		/// Returns <b>true</b> if Error has occured, else <b>false</b>.
		/// </summary>
		...
		/// <summary>
		/// Returns <b>true</b> if warning has occured, else <b>false</b>.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the <see cref="AbstractRequestType.Version"/> for the API call.
		/// </summary>
		/// <remarks>This property allows you to override the value set in <see cref="ApiContext"/></remarks>
		...
		/// <summary>
		/// Gets or sets the Site for the API call of type <see cref="SiteCodeType"/>
		/// </summary>
		/// <remarks>This property allows you to override the value set in <see cref="ApiContext"/></remarks>
