...
namespace eBay.Service.Core.Sdk
{
	...
	public class ExceptionFilter
	{
		...
		///    match any exception.)
		/// 2. If the exception is an ApiException and has an error code configured in TriggerErrorCodes, the exception matches.
		/// 3. If the exception is an ApiException containing (wrapping) an HttpException with a code configured in TriggerHttpStatusCodes,
